...
document.querySelector('.periodic').innerHTML = elements.map(el => '<li class="element">'+el+'</li>').join('');

export default class TablMendeleev extends React.Component {
